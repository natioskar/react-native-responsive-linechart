...
var Chart = function (props) {
    ...
    return (React.createElement(react_native_1.View, { style: style, onLayout: onLayout }, !!dimensions && (React.createElement(react_native_gesture_handler_1.TapGestureHandler, { enabled: !disableTouch, onHandlerStateChange: _onTouchGestureEvent, ref: tapGesture, simultaneousHandlers: panGesture },
        React.createElement(react_native_1.Animated.View, { style: { width: dimensions.width, height: dimensions.height } },
            React.createElement(react_native_gesture_handler_1.PanGestureHandler, { enabled: !disableGestures, minDeltaX: 0, minDeltaY: 0, onGestureEvent: _onPanGestureEvent, onHandlerStateChange: _onPanGestureEvent, ref: panGesture, simultaneousHandlers: tapGesture },
                React.createElement(react_native_1.Animated.View, { style: { width: dimensions.width, height: dimensions.height } },
