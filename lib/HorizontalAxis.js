...
var HorizontalAxis = function (props) {
    ...
    var finalTickValues = Axis_utils_1.calculateTickValues(tickValues, tickCount, domain.x, includeOriginTick).filter(function (v) { return v >= viewportDomain.x.min && v <= viewportDomain.x.max; });
    console;
